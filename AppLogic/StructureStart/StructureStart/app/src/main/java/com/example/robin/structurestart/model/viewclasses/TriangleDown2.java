 ...
 *
 */
 public class TriangleDown2 extends View {
     ...
     */
    public TriangleDown2(Context context, Paint backgroundPaint, Paint linePaint, Paint trianglePaint, Boolean triangleFilled) {
        super(context);
